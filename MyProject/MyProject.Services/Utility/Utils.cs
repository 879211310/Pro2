...
namespace MyProject.Services.Utility
{
    ...
    public class Utils
    {
        ...
        /// 获取站点根目录
        /// </summary>
        /// <returns>反悔站点根目录</returns>
        public static string GetWebSiteBasePath()
        {
...
#pragma warning restore 168
        ...
        public static string GetThumbnailImages(string imagesurl)
        {
            return imagesurl.ToLower().Replace("original", "thumbnails");
        }

        public static string GetOriginalImages(string imagesurl)
        {
            return imagesurl.ToLower().Replace("thumbnails", "original");
        }
        ...
        {
            var ip = HttpContext.Current.Request.ServerVariables["HTTP_VIA"] != null
        ...
        public static string GetColorCode(string colorName)
        {
            switch (colorName)
            {
                case "军绿色": return "#5d762a";
                case "天蓝色": return "#1eddff";
                case "巧克力色": return "#d2691e";
                case "桔色": return "#ffa500";
                case "浅灰色": return "#e4e4e4";
                case "浅绿色": return "#98fb98";
                case "浅黄色": return "#ffffb1";
                case "深卡其布色": return "#bdb76b";
                case "深灰色": return "#666666z";
                case "深紫色": return "#4b0082";
                case "深蓝色": return "#041690";
                case "白色": return "#ffffff";
                case "粉红色": return "#ffb6c1";
                case "紫罗兰": return "#dda0dd";
                case "紫色": return "#800080";
                case "红色": return "#ff0000";
                case "绿色": return "#008000";
                case "花色": return "assortment";
                case "蓝色": return "#0000ff";
                case "褐色": return "#855b00";
                case "透明": return "transparent";
                case "肤色": return "transparent";
                case "酒红色": return "#990000";
                case "黄色": return "#ffff00";
